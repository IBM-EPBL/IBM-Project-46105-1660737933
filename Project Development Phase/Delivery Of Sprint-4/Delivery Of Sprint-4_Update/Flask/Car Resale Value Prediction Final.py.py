...
API_KEY = "qxfbFLITIJs7zvC2zCQmXDBJbJUFCg7XcOjzi8c_VOoA"
...
def load_model(file='Car resale Value Prediction.sav'):#load the saved model
...
def search_page():#predicting page
...
def predict():
	...
	response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/3a954226-cb57-470d-ac48-8856da8a9f68/predictions?version=2022-11-23', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
